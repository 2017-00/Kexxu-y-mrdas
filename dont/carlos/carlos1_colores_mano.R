...
write.csv(locs_df, file = "C:/Users/ignaz/Downloads/final/final/kexxu/carlos/carlos1.csv", row.names = FALSE)


# Graficar
ggplot(locs_df, aes(x = x, y = y)) +
  geom_point(aes(x = 638, y = 720-301), color = "black", shape = 16, size = 4) +
  geom_point(aes(x = 749, y = 720-296), color = "black", shape = 3, size = 4) +
