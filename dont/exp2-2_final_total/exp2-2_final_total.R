...
ggplot(locs_df, aes(x = x, y = y)) + 
  ...
  geom_point(aes(x = 263.13, y = 1066.5), color = "black", alpha = 0.75, size = 1.5) +
  geom_point(aes(x = 960, y = 1066.5), color = "black", alpha = 0.75, size = 1.5) +
  geom_point(aes(x = 1656.87, y = 1066.5), color = "black", alpha = 0.75, size = 1.5) +
  geom_point(aes(x = 263.13, y = 540), color = "black", alpha = 0.75, size = 1.5) +
  geom_point(aes(x = 960, y = 540), color = "black", alpha = 0.75, size = 1.5) +
  geom_point(aes(x = 1656.87, y = 540), color = "black", alpha = 0.75, size = 1.5) +
  geom_point(aes(x = 263.13, y = 13.5), color = "black", alpha = 0.75, size = 1.5) +
  geom_point(aes(x = 960, y = 13.5), color = "black", alpha = 0.75, size = 1.5) +
  geom_point(aes(x = 1656.87, y = 13.5), color = "black", alpha = 0.75, size = 1.5) +
  theme_minimal() +
    ...
    scale_y_continuous(breaks = seq(-3000, 1200, by = 150)) +
